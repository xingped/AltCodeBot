...
def main():
	...
	unidict = {
		...
		'\u2568': 'ALT+208, "Box Drawings Up Doublw And Horizontal Single"',
	...
	# Start session
	session = praw.Reddit('AltCodeBot v0.1 by /u/xingped')
	...
	# Build ignore set
	ignore_users = set(['altcodebot', 'autowikibot'])
	...
	try:
		for comment in praw.helpers.comment_stream(session, subreddit, verbosity=0):
			...
			replytext += "\n\nPlease let me know if you like me, hate me, think I've made a mistake, or want me ignore you or this subreddit!"
